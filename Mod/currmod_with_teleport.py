...
class skill10:
    ...
    def common_testing_show_targeted_question_dialog(self):
        ...
        cancel_text = (
            CommonLocalizationUtils.create_localized_string("sure",
                                                            tokens=(CommonSimUtils.get_active_sim_info(),),
                                                            text_color=CommonLocalizedStringColor.GREEN),)
        # Define the Dialogue
        # => Call the Class
...
def _load_foo(original, self, *args, **kwargs) -> Any:
    ...
    if simsskill == 2:
        ...
        CommonBuffUtils.add_buff(CommonSimUtils.get_active_sim_info(), 106899,
        ...
        CommonBuffUtils.add_buff(CommonSimUtils.get_active_sim_info(), 107439,
        ...
        CommonBuffUtils.add_buff(CommonSimUtils.get_active_sim_info(), 34888,
